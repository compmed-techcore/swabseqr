...
params$dlong$IndexSet=params$dlong$Plate_ID
params$dlong$IndexSet[params$dlong$IndexSet %in% c('Plate1', 'Plate2', 'Plate3', 'Plate4')]='Winter'
params$dlong$IndexSet[params$dlong$IndexSet %in% c('Plate5', 'Plate6', 'Plate7', 'Plate8')]='Spring'
params$dlong$IndexSet[params$dlong$IndexSet %in% c('Plate9', 'Plate10', 'Plate11', 'Plate12') ]='Summer'
params$dlong$IndexSet[params$dlong$IndexSet %in% c('Plate13', 'Plate14', 'Plate15', 'Plate16')]='Fall'

params$dwide$IndexSet=params$dwide$Plate_ID
params$dwide$IndexSet[params$dwide$IndexSet %in% c('Plate1', 'Plate2', 'Plate3', 'Plate4')]='Winter'
params$dwide$IndexSet[params$dwide$IndexSet %in% c('Plate5', 'Plate6', 'Plate7', 'Plate8')]='Spring'
params$dwide$IndexSet[params$dwide$IndexSet %in% c('Plate9', 'Plate10', 'Plate11', 'Plate12') ]='Summer'
params$dwide$IndexSet[params$dwide$IndexSet %in% c('Plate13', 'Plate14', 'Plate15', 'Plate16')]='Fall'

psplit=split(params$dlong, params$dlong$IndexSet)
...
## Tube locations (384)
```{r echo=FALSE, fig.height=10, fig.width=12}
psplit=split(params$dwide, params$dwide$IndexSet)
lapply(psplit, function(x) {
           x%>%
#params$dwide %>% 
